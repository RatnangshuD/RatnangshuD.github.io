...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/SocialSTT/hardware1.gif" title="Hardware demonstration Case 1" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/SocialSTT/hardware2.gif" title="Hardware demonstration Case 2" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
